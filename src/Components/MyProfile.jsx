                    ...
                    <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
                        ...
                        <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                            ...
                            <div className="my-2 space-y-1">
                                <h2 className="text-xl font-semibold sm:text-2xl">{`${user && user.displayName}`}</h2>

                                <p className="  text-xs sm:text-base dark:text-gray-600">{`${user && user.email}`}</p>
                            </div>
                    ...
                    <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
                        <div className="card-body">
                            <form onSubmit={manualUpdate} className="fieldset">
                                <h1 className='text-center text-2xl font-semibold'>Update Information</h1>
