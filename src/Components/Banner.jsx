...
const images = [
    ...
    "https://www.rentcafe.com/blog/wp-content/uploads/sites/62/2021/02/Splitting-Rent-with-Roommates-3.jpg",
    ...
    return (
        <div>
            <div className='  place-items-center px-5 '>
                <div className="relative overflow-hidden mt-5 shadow-2xl w-11/12  rounded-2xl border-2">
                    <div
