...
const BrowseListing = () => {
    ...
    return (
        <SpinnerLoader>
            <div className="w-full min-h-screen flex flex-col items-center justify-start py-12 px-4 sm:px-6 lg:px-8  ">
                <div className="w-full max-w-6xl  shadow-lg rounded-xl p-6 overflow-x-auto">
                    ...
                    <table className="min-w-full table-auto border-collapse border border-gray-300 text-sm sm:text-base">
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {posts.map(post => (
                                <tr key={post._id} className="hover:bg-base-200 transition">
